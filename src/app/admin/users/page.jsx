  ...
  return (
    <div className="bg-gray-900 text-white min-h-screen">
      ...
      <div className="flex flex-col items-center justify-center py-20">
        ...
        <Link
          href="/admin"
          className="mt-4 flex items-center bg-[#0b1c2c] hover:bg-[#0b1c2c] text-white py-2 px-6 rounded-full focus:outline-none focus:ring-2 focus:ring-blue-500 text-sm"
        >
