...
*/
-- DropForeignKey
ALTER TABLE "activity_logs" DROP CONSTRAINT "activity_logs_book_id_fkey";

-- DropForeignKey
ALTER TABLE "activity_logs" DROP CONSTRAINT "activity_logs_user_id_fkey";

-- DropForeignKey
ALTER TABLE "reading_list_items" DROP CONSTRAINT "reading_list_items_bookId_fkey";

-- DropForeignKey
ALTER TABLE "reading_list_items" DROP CONSTRAINT "reading_list_items_readingListId_fkey";

-- DropForeignKey
ALTER TABLE "reading_lists" DROP CONSTRAINT "reading_lists_userId_fkey";
...
-- AlterTable
ALTER TABLE "activity_logs" DROP COLUMN "book_id",
DROP COLUMN "user_id",
